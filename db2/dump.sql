...
--
-- Name: ventasTot(double precision); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."ventasTot"(venta double precision) RETURNS double precision
    LANGUAGE plpgsql
    AS $_$
DECLARE 
	total integer;
...
ALTER FUNCTION public."ventasTot"(venta double precision) OWNER TO postgres;

--
-- Name: ventasTot(integer); Type: FUNCTION; Schema: public; Owner: postgres
--

CREATE FUNCTION public."ventasTot"(venta integer) RETURNS integer
    LANGUAGE plpgsql
    AS $_$
DECLARE 
	total integer;
...
ALTER FUNCTION public."ventasTot"(venta integer) OWNER TO postgres;
...
--
-- Name: vw_ventacab; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.vw_ventacab AS
 SELECT empleados.emple_nombre,
    ventas.emple_id,
    clientes.cliente_id,
    ...
    ventas.vent_tipo,
    ventas.vent_id,
    public."ventasTot"(ventas.vent_id) AS "ventasTot"
   FROM ((public.ventas
     JOIN public.empleados ON ((ventas.emple_id = empleados.emple_id)))
     JOIN public.clientes ON ((ventas.cliente_id = clientes.cliente_id)));


ALTER TABLE public.vw_ventacab OWNER TO postgres;
...
INSERT INTO public.ventas VALUES (3, 1, 1, '2018-02-19', '234', 1, 1);
INSERT INTO public.ventas VALUES (4, 3, 2, '2018-02-19', '234', 1, 1);
...
SELECT pg_catalog.setval('public.gastos_gast_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.movtipo_tmov_id_seq', 1, false);
...
SELECT pg_catalog.setval('public.rubros_rubro_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.tcajas_tcaja_id_seq', 1, false);
